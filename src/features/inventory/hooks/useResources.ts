...
import { resourcesApi } from '@/features/inventory/api/resources.api';
import type { CreateResourceDto, UpdateResourceDto } from '@/features/inventory/api/resources.api';
