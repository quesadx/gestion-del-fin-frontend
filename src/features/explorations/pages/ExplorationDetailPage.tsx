  ...
  return (
    <div className="space-y-6">
      ...
      <GlassPanel title={exp.destination} tag={`EXP.${exp.id}`} status={exp.status} accent="cyan">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 font-sans text-xs text-xs mb-4">
          <div>
        ...
        {exp.notes && (
          <div className="space-y-1 font-sans text-xs text-xs mb-4">
        ...
        {exp.members && exp.members.length > 0 ? (
          <div className="overflow-x-auto">
            <table className="w-full text-left font-sans text-xs text-xs">
              ...
              <tbody>
                {exp.members.map((m, i) => (
                  <tr key={m.person_id || i} className="border-b border-gdf-border-subtle">
          ...
          <div className="flex items-center gap-2 py-4 font-sans text-xs text-xs text-muted-foreground">
            ...
            <table className="w-full text-left font-sans text-xs text-xs">
              ...
              <tbody>
                {exp.allocated_resources.map((r, i) => (
                  <tr key={r.resource_type_id || i} className="border-b border-gdf-border-subtle">
