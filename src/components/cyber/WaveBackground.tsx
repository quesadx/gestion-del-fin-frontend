export function WaveBackground() {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
      ...
      />
      <div
        className="absolute -bottom-[20%] -right-[10%] w-[60vw] h-[60vw] opacity-18"
        style={{
      ...
      />
      <div
        className="absolute top-[30%] left-[35%] w-[45vw] h-[45vw] opacity-12"
        style={{
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at center, transparent 30%, oklch(0.04 0.01 255 / 0.7) 100%)',
        }}
      />
    </div>
  );
