        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="space-y-3">
            ...
            <h1 className="font-sans text-3xl font-extrabold tracking-tight">
              <span className="text-gdf-accent-primary gdf-glow-text">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {campCount !== null && (
            <GlassPanel accent="cyan" variant="default" className="h-full">
              ...
              <div className="flex items-baseline gap-2">
                <span className="font-sans text-3xl font-bold text-gdf-accent-primary">
                  {campCount}
                </span>
          ...
          {autoDailyCount !== null && (
            <GlassPanel accent="amber" variant="default" className="h-full">
              ...
              <div className="flex items-baseline gap-2">
                <span className="font-sans text-3xl font-bold text-gdf-status-warning">
                  {autoDailyCount}
                </span>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {inventoryItemCount !== null && (
              <GlassPanel accent="green" variant="default" className="h-full">
                ...
                <div className="flex items-baseline gap-2">
                  <span className="font-sans text-3xl font-bold text-gdf-status-success">
                    {inventoryItemCount}
                  </span>
